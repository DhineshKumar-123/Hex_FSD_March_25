...
//	
	...
	public Customer addCustomer(@RequestBody Customer customer) throws InvalidUsernameException//this @requestbody is to get the request and give it to the Customer Model
	{
...
//		return null;
	...
	public ResponseEntity<?> updateCustomer(@PathVariable int id, @RequestBody Customer newValue) throws InvalidUsernameException//Request body is used to get the input from the user
	{
	...
	public ResponseEntity<?> addCustomersFromExcel(@RequestParam MultipartFile file) throws IOException, InvalidUsernameException
	{
		...
		return ResponseEntity.ok("Customers from excel added to DB");
	}
